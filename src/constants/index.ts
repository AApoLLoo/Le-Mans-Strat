...
export const MAP_SECTOR_DEBOUNCE_MS = 2000;
export const MAP_LOOP_CLOSURE_DISTANCE = 15;
export const MAP_DOT_SCALE = 0.006;
export const MAP_STROKE_SCALE = 0.002;
export const MAP_LABEL_SCALE = 0.02;
