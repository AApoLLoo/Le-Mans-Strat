      ...
      <div className="bg-slate-900/60 border border-white/10 rounded-xl p-3 flex items-center justify-between shrink-0 shadow-lg">
          <div className="flex items-center gap-6">
              ...
              <div className="flex gap-4 text-xs">
                <div><span className="text-slate-500 font-bold">AIR</span> <span className="text-white">{airTemp}°C</span></div>
        ...
        <div className="col-span-3 flex flex-col gap-3">
            <div className="bg-slate-900/50 rounded-xl p-4 border border-white/5 flex-1">
                <div className="flex justify-between items-center mb-2">
                    ...
                    {(isHypercar || isCategoryGT3) && <button onClick={() => setShowVirtualEnergy(!showVirtualEnergy)} className="text-slate-500 hover:text-white"><RefreshCw size={12}/></button>}
                </div>
